          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-5 md:gap-8">
            <div>
              ...
              <div className="space-y-3">
                <a href="#features" className="block text-sm" style={{ color: "#666" }}>Features</a>
                <a href="#faq" className="block text-sm" style={{ color: "#666" }}>FAQ</a>
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Changelog</a>
              </div>
            </div>
            <div>
              <p className="mb-4 text-sm font-medium">Resources</p>
              <div className="space-y-3">
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Documentation</a>
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Blog</a>
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Support</a>
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Status</a>
              </div>
            </div>
            <div>
              <p className="mb-4 text-sm font-medium">Company</p>
              <div className="space-y-3">
                <a href="#" className="block text-sm" style={{ color: "#666" }}>About</a>
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Careers</a>
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Contact</a>
              </div>
            </div>
            <div>
              <p className="mb-4 text-sm font-medium">Legal</p>
              <div className="space-y-3">
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Terms of service</a>
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Privacy policy</a>
                <a href="#" className="block text-sm" style={{ color: "#666" }}>Not legal advice</a>
              </div>
            </div>
            <div>
              <p className="mb-4 text-sm font-medium">Connect</p>
              <div className="space-y-3">
                <a href="https://x.com" className="block text-sm" style={{ color: "#666" }}>X</a>
                <a href="https://linkedin.com" className="block text-sm" style={{ color: "#666" }}>LinkedIn</a>
                <a href="https://github.com" className="block text-sm" style={{ color: "#666" }}>GitHub</a>
              </div>
            </div>
          </div>
          <div className="mt-12 flex flex-col items-center justify-between gap-4 pt-6 md:flex-row" style={{ borderTop: "1px solid #2a2722" }}>
            <p className="text-xs" style={{ color: "#555" }}>© 2026 TrackSign. All rights reserved.</p>
            <p className="text-center text-xs" style={{ color: "#555" }}>TrackSign does not provide legal advice.</p>
          </div>
        </div>
      </footer>
    </>
